...
the_nun = media.Movie(
    ...
    "https://www.youtube.com/watch?v=pzD9zGcUNrw&ab_channel=WarnerBros.\
    Pictures",
    "5.6/10", "Horor"
)
...
fury = media.Movie(
    ...
    "https://www.youtube.com/watch?v=DNHuK1rteF4&ab_channel=\
    MovieclipsTrailers",
...
war_for_the_planet_of_apes = media.Movie(
    ...
    "Caesarand his apes are forced into a deadly conflict with an\
     army of humans.",
    "https://bit.ly/2yhWicn",
    "https://www.youtube.com/watch?v=qxjPjPzQ1iU&t=15s&ab_channel=\
    PlanetoftheApes",
    "7.5/10", " Action , Adventure , Drama"
)

blackhat = media.Movie(
    "Blackhat (2015)",
    "A furloughed convict and his American and Chinese partners hunt a high-level \
    cybercrime network from Chicago to Los Angeles to Hong Kong to Jakarta.",
    "https://bit.ly/2ODll3K",
    "https://www.youtube.com/watch?v=jZ1ZDlLImF8&ab_channel=\
...
edge_of_tomorrow = media.Movie(
    ...
    "https://www.youtube.com/watch?v=vw61gCe2oqI&ab_channel=WarnerBros.\
    Pictures",
...
train_to_busan = media.Movie(
    ...
    "https://www.youtube.com/watch?v=1d4DACwz49o&ab_channel=\
    ZeroMedia",
    "7.9/10", "Action , Horror , Thriller"
)

'''
the movies var which has all the instance variables\
to be used at the following function,
which will allow the HTML displays\
all of the provided movies data
'''
movies = [the_nun, fury, war_for_the_planet_of_apes,
          blackhat, edge_of_tomorrow, train_to_busan]

'''function that will take inthe  list of movies and generate an HTML\
file including this content,
